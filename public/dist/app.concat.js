...
save_button.addEventListener('click', function(){
    ...
    if (!can_save) {
      alertify.alert('Nice try ' + data.name + '!', function(){
    ...
    req.onload = function() {
      ...
      if (success) {
        ...
        localStorage.setItem("onleaderboard", !data.hacker); // User can be on leaderboard unless he hacked the timer..
        localStorage.setItem("ishacker", data.hacker);
